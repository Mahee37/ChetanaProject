...
<div class="container mt-5">
    ...
    <form method="post" action="${pageContext.request.contextPath}/editProducts">
        <!-- Hidden field for productId if not using request parameter -->
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="productDiscountPrice" name="discount_price" value="${product.discountPrice}" required>
        </div>
